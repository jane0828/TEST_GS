    ...
    if(show_typingWindow) {
        ...
        switch(gen_fnccode) {
            ...
            case 16: { //u32bool13
                ...
                ImGui::InputScalar("11u32",ImGuiDataType_U32, &command->u32bool13.ItemSize);
                ImGui::InputScalar("12u32",ImGuiDataType_U32, &command->u32bool13.ItemCount);
                ImGui::InputScalar("11u8",ImGuiDataType_U8, &command->u32bool13.Node);
                ImGui::InputScalar("12u8",ImGuiDataType_U8, &command->u32bool13.TableId);
                ImGui::InputScalar("13u16",ImGuiDataType_U16, &command->u32bool13.Address);
                ImGui::InputScalar("13u8",ImGuiDataType_U8, &command->u32bool13.Type);
                ...
                if(ImGui::Button("Generate CMD")) {
                    ...
                    memcpy(TestPacket->Data, &command->u32u8, sizeof(u32bool13_t));
...
{   
    ...
    snprintf(Templabels[13], 64, "U32U8U8U8");
    snprintf(Templabels[14], 64, "U32U32U8U8U16U8");
    snprintf(Templabels[15], 64, "U32U32U32U8U8U16U8");
